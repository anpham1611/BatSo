...
import com.apmv.batso.data.Meta;
import com.apmv.batso.data.model.Account;
...
public class ApiRequest {
    ...
    public Request getExternalApiRequest(String url) {
        return buildExternalApiRequest(url);
    }
    ...
    private Request buildExternalApiRequest(String url) {
        return new Request.Builder()
                .headers(buildRequestHeaders())
                .url(url)
                .get()
    ...
    private Headers buildRequestHeaders() {
        ...
        if (Account.currentUser() != null && Account.currentUser().getApi_token() != null) {
            builder.add("Api-Token", Account.currentUser().getApi_token());
        }
